              ...
              <template v-slot:body="props">
                <q-tr :props="props">
                  ...
                  <q-td key="operation" :props="props">
                    <q-btn-group>
                      <q-btn @click="fnOpenAlertEditSourceProject(props.row.operation)" color="warning" icon="edit" outline>
                        编辑
                      </q-btn>
                      <q-btn @click="fnDestroySourceProject(props.row.operation)" color="negative" icon="delete" outline>
                        删除
                      </q-btn>
                    </q-btn-group>
                  </q-td>
