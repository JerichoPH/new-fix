    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建室内上道位置-排" icon="add" @click="fnOpenAlertCreateInstallIndoorPlatoon" />
              <q-btn color="negative" outline label="删除室内上道位置-排" icon="deleted" @click="fnDestroyInstallIndoorPlatoons" />
            </q-btn-group>
          </div>
        </div>
        <div class="row q-mt-md">
                ...
                <q-tr :props="props">
                  ...
                  <q-td key="operation" :props="props">
                    <q-btn-group>
                      ...
                      <q-btn @click="fnDestroyInstallIndoorPlatoon(props.row.operation)" color="negative" icon="delete" outline label="删除" />
                    </q-btn-group>
                  </q-td>
                </q-tr>
              </template>
