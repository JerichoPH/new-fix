    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建线别" icon="add" @click="fnOpenAlertCreateCreateOrganizationLine" />
              <q-btn color="negative" outline label="删除线别" icon="deleted" @click="fnDestroyCreateOrganizationLines" />
            </q-btn-group>
          </div>
        </div>
        <div class="row q-mt-md">
