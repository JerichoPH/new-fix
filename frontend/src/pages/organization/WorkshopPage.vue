    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建车间" icon="add" @click="fnOpenAlertCreateOrganizationWorkshop" />
              <q-btn color="negative" outline label="删除车间" icon="deleted" @click="fnDestroyOrganizationWorkshops" />
            </q-btn-group>
          </div>
        </div>
        <div class="row q-mt-md">
