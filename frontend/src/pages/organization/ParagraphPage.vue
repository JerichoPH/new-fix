    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建站段" icon="add" @click="fnOpenAlertCreateOrganizationParagraph" />
              <q-btn color="negative" outline label="删除站段" icon="deleted" @click="fnDestroyOrganizationParagraphs" />
            </q-btn-group>
          </div>
        </div>
                ...
                <q-tr :props="props">
                  ...
                  <q-td key="operation" :props="props">
                    <q-btn-group>
                      ...
                      <q-btn @click="fnDestroyOrganizationParagraph(props.row.operation)" color="negative" icon="delete" outline label="删除" />
                    </q-btn-group>
                  </q-td>
                </q-tr>
              </template>
