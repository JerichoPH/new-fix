    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建故障类型" icon="add" @click="fnOpenAlertCreateBreakdownType" />
              <q-btn color="negative" outline label="删除故障类型" icon="deleted" @click="fnDestroyBreakdownTypes" />
            </q-btn-group>
          </div>
        </div>
        <div class="row q-mt-md">
              ...
              <template v-slot:body="props">
                <q-tr :props="props">
                  ...
                  <q-td key="operation" :props="props">
                    <q-btn-group>
                      <q-btn @click="fnOpenAlertEditBreakdownType(props.row.operation)" color="warning" icon="edit" outline>
                        编辑
                      </q-btn>
                      <q-btn @click="fnDestroyBreakdownType(props.row.operation)" color="negative" icon="delete" outline>
                        删除
                      </q-btn>
                    </q-btn-group>
                  </q-td>
