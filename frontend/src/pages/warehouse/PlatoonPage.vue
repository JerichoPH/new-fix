    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建仓库-排" icon="add" @click="fnOpenAlertCreateWarehousePlatoon" />
              <q-btn color="negative" outline label="删除仓库-排" icon="deleted" @click="fnDestroyWarehousePlatoons" />
            </q-btn-group>
          </div>
        </div>
        <div class="row q-mt-md">
              ...
              <template v-slot:body="props">
                <q-tr :props="props">
                  ...
                  <q-td key="operation" :props="props">
                    <q-btn-group>
                      <q-btn @click="fnOpenAlertEditWarehousePlatoon(props.row.operation)" color="warning" icon="edit" outline label="编辑" />
                      <q-btn @click="fnDestroyWarehousePlatoon(props.row.operation)" color="negative" icon="delete" outline label="删除" />
                    </q-btn-group>
                  </q-td>
                </q-tr>
              </template>
