    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建仓库-架" icon="add" @click="fnOpenAlertCreateWarehouseShelf" />
              <q-btn color="negative" outline label="删除仓库-架" icon="deleted" @click="fnDestroyCreateWarehouseShelves" />
            </q-btn-group>
          </div>
        </div>
        <div class="row q-mt-md">
  ...
  <q-dialog v-model="alertEditWarehouseCell" no-backdrop-dismiss>
    <q-card :style="{ minWidth: '450px' }">
      ...
      <q-form class="q-gutter-md" @submit.prevent="fnUpdateWarehouseCell">
        ...
        <q-card-actions align="right">
          <q-btn color="negative" outline label="删除" icon="delete" @click="fnDestroyWarehouseCell" />
          <q-btn-group>
            <q-btn type="button" label="关闭" outline v-close-popup />
            <q-btn type="submit" label="确定" outline icon="check" color="warning" />
          </q-btn-group>
