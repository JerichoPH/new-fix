    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建器材型号" icon="add" @click="fnOpenAlertCreateEquipmentKindModel" />
              <q-btn color="negative" outline label="删除器材型号" icon="deleted" @click="fnDestroyEquipmentKindModels" />
            </q-btn-group>
          </div>
        </div>
              ...
              <template v-slot:body="props">
                <q-tr :props="props">
                  ...
                  <q-td key="operation" :props="props">
                    <q-btn-group>
                      <q-btn @click="fnOpenAlertEditEquipmentKindModel(props.row.operation)" color="warning" icon="edit" outline label="编辑" />
                      <q-btn @click="fnDestroyEquipmentKindModel(props.row.operation)" color="negative" icon="delete" outline label="删除" />
                    </q-btn-group>
                  </q-td>
                </q-tr>
              </template>
