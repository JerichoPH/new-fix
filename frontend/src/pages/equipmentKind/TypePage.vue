    ...
    <q-card class="q-mt-md">
      <q-card-section>
        <div class="row">
          ...
          <div class="col text-right">
            <q-btn-group>
              <q-btn color="secondary" outline label="新建器材类型" icon="add" @click="fnOpenAlertCreateEquipmentKindType" />
              <q-btn color="negative" outline label="删除器材类型" icon="deleted" @click="fnDestroyEquipmentKindTypes" />
            </q-btn-group>
          </div>
        </div>
              ...
              <template v-slot:body="props">
                <q-tr :props="props">
                  ...
                  <q-td key="operation" :props="props">
                    <q-btn-group>
                      <q-btn @click="fnOpenAlertEditEquipmentKindType(props.row.operation)" color="warning" icon="edit" outline label="编辑" />
                      <q-btn @click="fnDestroyEquipmentKindType(props.row.operation)" color="negative" icon="delete" outline label="删除" />
                    </q-btn-group>
                  </q-td>
                </q-tr>
              </template>
    ...
    <q-card :style="{ minWidth: '450px' }">
      ...
      <q-form class="q-gutter-md" @submit.prevent="fnUpdateEquipmentKindType">
        <q-card-section class="q-pt-none">
          <div class="row">
            <div class="col">
              <q-input outlined clearable lazy-rules v-model="name_alertEditEquipmentKindType" label="名称" :rules="[]" />
            </div>
          </div>
          <div class="row">
            <div class="col">
