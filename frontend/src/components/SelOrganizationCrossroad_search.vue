<template>
  <q-select outlined use-input clearable v-model="organizationCrossroadUuid_search"
    :options="organizationCrossroads_search" :display-value="organizationCrossroadsMap[organizationCrossroadUuid_search]"
...
const organizationCrossroadUuid_search = inject("organizationCrossroadUuid_search");
